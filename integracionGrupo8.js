...
refrescarEstudiante = function () {
  ...
  for (let i = 0; i < estudiantes.length; i++) {
    ...
    contenidoTabla +=
      "<tr><td>" +
      elementoEstudiante.nombre +
      "</td>" +
      "<td>" +
      elementoEstudiante.curso +
      "</td>" +
      "<td>" +
      elementoEstudiante.matricula +
      "</td>" +
      "</tr>";
  }
...
refrescar = function () {
  ...
  for (let i = 0; i < aulas.length; i++) {
    ...
    tabla +=
      "<tr>" +
      "<td>" +
      elementoAula.numeroAula +
      "</td>" +
      "<td>" +
      elementoAula.horario +
      "</td>" +
      "<td>" +
      elementoAula.capacidadMaxima +
      "</td>";
    ("</tr>");
  }
  tabla += "</table>";
...
eliminarProfesor = function () {
  console.log("Arreglo antes de eliminar", profesores2);
  profesores2 = profesores2.slice(1);
  console.log("Arreglo despues de eliminar", profesores2);
  refrescarProfesor2();
};
